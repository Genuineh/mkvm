export const TEXT = {
  cn: {
    ...
    settings: {
      ...
      performance: "性能监听",
      performanceCopy:
        "只在打开设置并启用监听时采样，展示 MKVM 进程、传输包和键鼠事件吞吐。",
      updates: "应用更新",
  ...
  en: {
    ...
    settings: {
      ...
      performanceCopy:
        "Sampling runs only while Settings is open and monitoring is enabled, showing MKVM process load, transport packets, and input throughput.",
      updates: "App Updates",
    ...
    errors: {
      ...
      probeFailed: "No mkvm response was received.",
